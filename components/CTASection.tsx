  ...
  return (
    <section className="py-20">
      <div className="container-max">
        <AnimateIn>
          <div className="relative overflow-hidden rounded-3xl border border-cream-deep bg-cream-soft px-8 py-16 text-center sm:px-16">
            <div
              className="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full opacity-30 blur-3xl"
              style={{ background: "var(--color-primary)" }}
            />
            <h2 className="font-heading text-4xl font-extrabold capitalize text-ink sm:text-5xl">{title}</h2>
